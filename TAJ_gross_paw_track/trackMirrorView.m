function [points2d,mirrorCentroid,timeList,isPawVisible] = trackMirrorView( video, triggerTime, initPawMask, BGimg_ud, sr_ratInfo, boxRegions, boxCalibration, varargin )
...
[fpoints2d, mirrorCentroid, timeList_f,isPawVisible_f] = trackPaw_mirror_local( video, BGimg_ud, initPawMask{2},pawBlob, boxRegions, pawPref, 'forward',boxCalibration,...
...
[rpoints2d,mirrorCentroid, timeList_b,isPawVisible_b] = trackPaw_mirror_local( video, BGimg_ud, initPawMask{2},pawBlob, boxRegions, pawPref, 'reverse',boxCalibration,...
                                     'foregroundthresh',foregroundThresh,...
                                     'pawhsvrange',pawHSVrange,...
                                     'maxdistperframe',maxDistPerFrame,...
                                     'targetmean',targetMean,...
...
function [points2d,mirrorCentroid,timeList,isPawVisible,mirror_image_ud] = trackPaw_mirror_local( video, ...
                                    BGimg_ud, ...
                                    initPawMask, ...
                                    pawBlob, ...
                                    boxRegions, ...
...
%     orig_image_ud = image_ud;
    ...
    [fullMask,~,centroid]  = trackNextStep_mirror(image_ud,fundMat,BGimg_ud,prevMask,boxRegions,pawPref,...
                             'foregroundthresh',foregroundThresh,...
                             'pawhsvrange',pawHSVrange,...
                             'maxdistperframe',maxDistPerFrame,...
                             'targetmean',targetMean,...
	...
	if any(fullMask(:))
        ...
        isPawVisible(currentFrame) = true;
        prevMask = fullMask;
        mirrorCentroid{currentFrame} = centroid;
    else
        points2d{currentFrame} = [];
        isPawVisible(currentFrame) = false;
        lastFrame = currentFrame;
        mirrorCentroid{currentFrame} =[];
